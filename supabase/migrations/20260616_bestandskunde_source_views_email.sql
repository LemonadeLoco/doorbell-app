-- Add email column, expand source constraint, update views for bestandskunde + phone2/email
-- Set cooldown to 6 months so Aug-Oct 2025 contracts appear in active queue
...
ALTER TABLE contacts ADD CONSTRAINT contacts_source_check
  CHECK (source = ANY (ARRAY[
    'tür','anruf','messe','markt','interessent','aroundhome','bestandskunde'
  ]));

INSERT INTO settings (key, value) VALUES ('call_cooldown_months', '6')
...
SELECT
  c.id, c.name, c.phone, c.phone2, c.address, c.email,
